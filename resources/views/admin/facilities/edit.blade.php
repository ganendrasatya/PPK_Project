<x-admin-layout>
    <x-slot name="header">
        ...
        <h1 class="text-2xl sm:text-3xl font-bold text-slate-900 mt-1">Edit Fasilitas</h1>
        <p class="text-slate-500 mt-1">Perbarui detail fasilitas "{{ $facility->nama_fasilitas }}".</p>
    </x-slot>
